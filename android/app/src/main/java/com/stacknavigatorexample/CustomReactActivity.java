...
public class CustomReactActivity extends AppCompatActivity implements DefaultHardwareBackBtnHandler, PermissionAwareActivity{

    private final CustomReactActivityDelegate mDelegate;
